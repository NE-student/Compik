...
function PropertyCreate(props) {
  ...
  // const [impactCategories, setImpactCategories] = React.useState(null);
    ...
    <>
      <Segment className="w-full">
        ...
        <Form onSubmit={handleSubmit(OnSubmit)}>
          ...
          <FormField className=" flex flex-row">
            <label className="text-slate-50">Кiлькiсна характеристика? </label>
            <input
              type="checkbox"
              {...register("isCountable")}
              className=" border-2 rounded font-normal"
            />
          </FormField>
          <DropdownRelation
